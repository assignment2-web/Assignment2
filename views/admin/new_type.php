...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="<?php echo URL; ?>admin/newed_type" method="post" id="frm-validate" name="edit-type" enctype="multipart/form-data">
            <div class="form-group">
                <label for="name">Tên <sup style="color: red;"> (*) </sup></label>
                <input type="text" class="form-control" name="name" value="" id="fullname" placeholder="Nguyễn Văn A">
            </div>
            <div class="form-group">
